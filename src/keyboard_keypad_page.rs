...
pub enum KeyboardKeypadPage {
    ...
    KeyboardY = 0x1c,
    KeyboardZ = 0x1d,
    //Keyboard 1 ! (Bang) = 0x1e,
    //Keyboard 2 @ (At) = 0x1f,
    //Keyboard 3 # (Hash) = 0x20,
    //Keyboard 4 $ (Dollar) = 0x21,
    //Keyboard 5 % (Percent) = 0x22,
    //Keyboard 6 ^ (Caret) = 0x23,
    //Keyboard 7 & (Ampersand) = 0x24,
    //Keyboard 8 * (Star) = 0x25,
    //Keyboard 9 ( (Left Bracket) = 0x26,
    //Keyboard 0 ) (Right Bracket) = 0x27,
    KeyboardEnter = 0x28,
    KeyboardEscape = 0x29,
    KeyboardBackspace = 0x2a,
    KeyboardTab = 0x2b,
    KeyboardSpace = 0x2c,
    //Keyboard - _ (Dash Underscore) = 0x2d,
    //Keyboard = + (Equals Plus) = 0x2e,
    //Keyboard [ { (Left Brace) = 0x2f,
    //Keyboard ] } (Right Brace) = 0x30,
    //Keyboard \ | (Backslash Pipe) = 0x31,
    //Keyboard # ~ (Non-US Hash Tilde) = 0x32,
    //Keyboard ; : (Semicolon Colon) = 0x33,
    //Keyboard ' " (Left Apos Double) = 0x34,
    //Keyboard ` ´ (Grave Accent Tilde) = 0x35,
    //Keyboard , < (Comma Less) = 0x36,
    //Keyboard . > (Period Greater) = 0x37,
    //Keyboard / ? (ForwardSlash QuestionMark) = 0x38,
    ...
    KeypadEnter = 0x58,
    //Keypad 1 End = 0x59,
    //Keypad 2 Down Arrow = 0x5a,
    //Keypad 3 PageDn = 0x5b,
    //Keypad 4 Left Arrow = 0x5c,
    //Keypad 5 = 0x5d,
    //Keypad 6 Right Arrow = 0x5e,
    //Keypad 7 Home = 0x5f,
    //Keypad 8 Up Arrow = 0x60,
    //Keypad 9 PageUp = 0x61,
    //Keypad 0 Insert = 0x62,
    //Keypad . Delete = 0x63,
